...
export const responseConfig: ResponseConfig = {
  templates: {
    explanation: {
      introduction: 'Let Teddy explain this concept clearly for you! 🧸',
      structure: [
        '## Overview',
    ...
    study_plan: {
      introduction: 'Teddy has created a cozy study plan just for you! 🧸📚',
      structure: [
        '## 📅 Timeline',
        '## 📚 Topics to Cover',
        '## 🎯 Learning Objectives',
    ...
    practice: {
      introduction: 'Teddy has some practice questions to help you learn! 🧸✨',
      structure: [
        '## Questions',
        '## Hints',
        '## Solutions',
    ...
    concept: {
      introduction: 'Let\'s explore this concept together! Teddy loves learning new things! 🧸💡',
      structure: [
        '## 📖 Definition',
        '## 🔍 Detailed Explanation',
        '## 💡 Examples',
