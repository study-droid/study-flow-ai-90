  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': mode === 'development' ? [
        ...
        "connect-src 'self' http://localhost:* http://127.0.0.1:* ws: wss: https://*.supabase.co wss://*.supabase.co https://generativelanguage.googleapis.com https://*.googleapis.com https://ai.google.dev https://cdn.freesound.org https://openrouter.ai https://api.openai.com",
        ...
        "font-src 'self' https://fonts.gstatic.com data:",
        "img-src 'self' data: https: blob:",
        "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://generativelanguage.googleapis.com https://*.googleapis.com https://ai.google.dev https://cdn.freesound.org",
        "media-src 'self' https://cdn.freesound.org https:",
        "object-src 'none'",
        "frame-ancestors 'none'",
        "base-uri 'self'",
